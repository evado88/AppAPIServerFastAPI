...
from apps.tpsuperapp.models.review_stages_model import ReviewStage, ReviewStageItem
from apps.tpsuperapp.models.status_types_model import StatusType, StatusTypeItem
from apps.tpsuperapp.models.user_role_model import UserRole, UserRoleItem
...
class UserDB(Base):
    ...
    # relationships
    stage = relationship("ReviewStageDB", back_populates="users", lazy="raise")
    status = relationship("StatusTypeDB", back_populates="users", lazy="raise")
    role = relationship("UserRoleDB", back_populates="users", lazy="raise")
    config = relationship("AppConfigurationDB", back_populates="user", lazy="raise")
    customers = relationship("CustomerDB", back_populates="user", lazy="raise")
