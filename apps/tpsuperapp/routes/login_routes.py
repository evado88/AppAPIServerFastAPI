...
from apps.tpsuperapp.models.login_model import Login, LoginDB
...
async def create_status(login: Login, db: AsyncSession = Depends(get_tpsuperapp_db)):
...
async def list_logins(db: AsyncSession = Depends(get_tpsuperapp_db)):
