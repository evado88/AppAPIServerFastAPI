...
class DepartmentDB(Base):
    ...
    user = relationship("UserDB", back_populates="departments", lazy='selectin')
    status = relationship("StatusDB", back_populates="departments", lazy='selectin')
    stage = relationship("StageDB", back_populates="departments", lazy='selectin')
    attachment = relationship("AttachmentDB", back_populates="departments", lazy='selectin')
