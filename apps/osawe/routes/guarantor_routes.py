...
from apps.osawe.models.guarantor_model import Guarantor, GuarantorDB, GuarantorWithDetail
...
async def post_guarantor(guarantor: Guarantor, db: AsyncSession = Depends(get_osawe_db)):
    # check user exists
...
async def update_item(
    config_id: int, config_update: Guarantor, db: AsyncSession = Depends(get_osawe_db)
):
...
async def list_guarantors(db: AsyncSession = Depends(get_osawe_db)):
