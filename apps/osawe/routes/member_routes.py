...
from apps.osawe.models.member_model import Member, MemberDB, MemberWithDetail
...
async def register_member(member: Member, db: AsyncSession = Depends(get_osawe_db)):
...
async def update_member(
    id: int, member_update: Member, db: AsyncSession = Depends(get_osawe_db)
):
...
async def list_members(db: AsyncSession = Depends(get_osawe_db)):
...
async def initialize_validation_members(db: AsyncSession = Depends(get_osawe_db)):
