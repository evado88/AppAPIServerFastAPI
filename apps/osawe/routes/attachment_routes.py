...
from apps.osawe.models.attachment_model import Attachment, AttachmentDB, AttachmentInput
import csv
...
from apps.osawe.models.param_models import ParamAttachmentDetail
...
async def list_attachments(db: AsyncSession = Depends(get_osawe_db)):
