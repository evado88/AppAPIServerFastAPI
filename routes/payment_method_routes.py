...
from models.payment_method_model import (
    PaymentMethodDB,
    PaymentMethod,
...
async def post_paymentmethod(
    paymentmethod: PaymentMethod, db: AsyncSession = Depends(get_db)
):
    # check user exists
...
async def update_item(
    config_id: int, config_update: PaymentMethod, db: AsyncSession = Depends(get_db)
):
    result = await db.execute(
